...
def load_data(messages_filepath, categories_filepath):
    """Function to load the data from the messages and categories csv files.
        
        Args: 
            messages file path, categories file path
...
def clean_data(df):
    ...
    # create catergory dataframe of the 36 individual category columns
